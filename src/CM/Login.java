...
//		ImageIcon icon = new ImageIcon("/logo.png");
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"admin", "instructors", "students"}));
		...
		comboBox.setFont(new Font("Bookman Old Style", Font.PLAIN, 20));
		...
		JLabel cacc = new JLabel("Email:");
		cacc.setForeground(new Color(0, 0, 0));
		cacc.setBounds(316, 133, 96, 22);
		cacc.setFont(new Font("Bookman Old Style", Font.BOLD, 20));
		panel_1.add(cacc);

		JLabel lblNewLabel_1_1 = new JLabel("Password:");
		lblNewLabel_1_1.setForeground(new Color(0, 0, 0));
		lblNewLabel_1_1.setBounds(316, 202, 110, 22);
		lblNewLabel_1_1.setFont(new Font("Bookman Old Style", Font.BOLD, 20));
		panel_1.add(lblNewLabel_1_1);

		JLabel lblNewLabel_1_1_1 = new JLabel("User:");
		lblNewLabel_1_1_1.setForeground(new Color(0, 0, 0));
		lblNewLabel_1_1_1.setBounds(316, 293, 79, 22);
		lblNewLabel_1_1_1.setFont(new Font("Bookman Old Style", Font.BOLD, 20));
		panel_1.add(lblNewLabel_1_1_1);

		invalid2.setForeground(new Color(255, 0, 0));
		invalid2.setFont(new Font("Bookman Old Style", Font.ITALIC, 9));
		panel_1.add(invalid2);

		invalid1.setForeground(new Color(255, 0, 0));
		invalid1.setFont(new Font("Bookman Old Style", Font.ITALIC, 9));
