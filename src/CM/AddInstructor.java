...
public class AddInstructor {
	...
	private void initialize() {
		...
		btnNewButton.setBounds(174, 136, 112, 21);
		...
		lblNewLabel_1_1.setFont(new Font("Bookman Old Style", Font.BOLD, 12));
		lblNewLabel_1_1.setBounds(261, 21, 70, 13);
		panel_1.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_1_2 = new JLabel("Password");
		lblNewLabel_1_2.setFont(new Font("Bookman Old Style", Font.BOLD, 12));
		lblNewLabel_1_2.setBounds(107, 64, 70, 13);
		panel_1.add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_1_3 = new JLabel("Phone Number");
		lblNewLabel_1_3.setFont(new Font("Bookman Old Style", Font.BOLD, 12));
