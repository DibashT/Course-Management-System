...
public class Dashboard {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_2_1 = new JLabel("Tutors");
		lblNewLabel_2_1.setBounds(472, 58, 177, 46);
		lblNewLabel_2_1.setFont(new Font("Bookman Old Style", Font.BOLD, 24));
		...
		lblNewLabel_3.setFont(new Font("Bookman Old Style", Font.BOLD, 50));

		JLabel lblNewLabel_2_3 = new JLabel("Modules");
		lblNewLabel_2_3.setBounds(39, 230, 197, 46);
		lblNewLabel_2_3.setFont(new Font("Bookman Old Style", Font.BOLD, 24));
		...
		JLabel lblNewLabel_2_3_1 = new JLabel("Students");
		lblNewLabel_2_3_1.setBounds(472, 230, 197, 46);
		lblNewLabel_2_3_1.setFont(new Font("Bookman Old Style", Font.BOLD, 24));

		Student s = new Student();
		JLabel lblNewLabel_6 = new JLabel("" + s.getStudents().size());
		lblNewLabel_6.setBounds(472, 282, 197, 69);
		lblNewLabel_6.setFont(new Font("Bookman Old Style", Font.BOLD, 50));
		...
		lblNewLabel_2_2_5.setFont(new Font("Bookman Old Style", Font.BOLD, 30));
		lblNewLabel_2_2_5.setBounds(266, 23, 175, 46);
		...
		lblNewLabel_2_2.setFont(new Font("Bookman Old Style", Font.BOLD, 20));

		JLabel lblNewLabel_2_2_4 = new JLabel("Courses");
		lblNewLabel_2_2_4.setBounds(10, 13, 124, 46);
		lblNewLabel_2_2_4.setFont(new Font("Bookman Old Style", Font.BOLD, 25));
		...
		lblNewLabel_7.setFont(new Font("Bookman Old Style", Font.BOLD, 63));
		...
		table.setFont(new Font("Bookman Old Style", Font.BOLD, 10));
		...
		lblNewLabel_2_2_6.setFont(new Font("Bookman Old Style", Font.BOLD, 20));
		...
		lblNewLabel_7_2.setFont(new Font("Bookman Old Style", Font.BOLD, 63));
		...
		table_1.setFont(new Font("Bookman Old Style", Font.BOLD, 10));
		...
		editCourse.setBackground(Color.GRAY); // Set background color to gray
		editCourse.setForeground(Color.WHITE); // Set text color to white
		editCourse.setFont(new Font("Bookman Old Style", Font.BOLD, 9));
		...
		btnDelete.setFont(new Font("Bookman Old Style", Font.BOLD, 9));
		btnDelete.setBorderPainted(false);
		btnDelete.setBackground(Color.GRAY); // Set background color to gray
		...
		addCourse.setForeground(Color.WHITE); // Set text color to white
		addCourse.setFont(new Font("Bookman Old Style", Font.BOLD, 9));
		addCourse.setBorderPainted(false);
		addCourse.setBackground(Color.GRAY); // Set background color to gray
		...
		addModule.setFont(new Font("Bookman Old Style", Font.BOLD, 9));
		addModule.setBorderPainted(false);
		addModule.setBackground(Color.GRAY); // Set background color to gray
		...
		deleteModule.setFont(new Font("Bookman Old Style", Font.BOLD, 9));
		deleteModule.setBorderPainted(false);
		deleteModule.setBackground(Color.GRAY); // Set background color to gray
		...
		lblNewLabel_2_2_1.setFont(new Font("Bookman Old Style", Font.BOLD, 20));

		JLabel lblNewLabel_2_2_3 = new JLabel("Tutors");
		lblNewLabel_2_2_3.setBounds(10, 10, 92, 46);
		lblNewLabel_2_2_3.setFont(new Font("Bookman Old Style", Font.BOLD, 25));

		JLabel lblNewLabel_7_1 = new JLabel("" + i.getInstructor().size());
		lblNewLabel_7_1.setBounds(48, 114, 197, 69);
		lblNewLabel_7_1.setFont(new Font("Bookman Old Style", Font.BOLD, 63));
		...
		instructorTable.setFont(new Font("Bookman Old Style", Font.BOLD, 10));
		...
		editTutor.setFont(new Font("Bookman Old Style", Font.BOLD, 11));
		...
		deleteTutor.setFont(new Font("Bookman Old Style", Font.BOLD, 11));
		...
		assignModule.setFont(new Font("Bookman Old Style", Font.BOLD, 11));
		...
		lblNewLabel_2_2_2.setFont(new Font("Bookman Old Style", Font.BOLD, 25));

		JLabel lblNewLabel_9_2 = new JLabel("Email:");
		lblNewLabel_9_2.setBounds(53, 110, 64, 16);
		lblNewLabel_9_2.setFont(new Font("Bookman Old Style", Font.BOLD, 14));
		

		JLabel lblNewLabel_8_1 = new JLabel("Security");
		lblNewLabel_8_1.setBounds(53, 172, 144, 25);
		lblNewLabel_8_1.setFont(new Font("Bookman Old Style", Font.BOLD, 16));

		JLabel lblNewLabel_9_3 = new JLabel("Old Password");
		lblNewLabel_9_3.setBounds(53, 217, 96, 20);
		lblNewLabel_9_3.setFont(new Font("Poppins", Font.BOLD, 13));
		...
		lblNewLabel_9_3_1.setFont(new Font("Bookman Old Style", Font.BOLD, 13));
		...
		btnNewButton_1_1.setFont(new Font("Bookman Old Style", Font.BOLD, 14));

		
		JLabel lblNewLabel_9_2_1 = new JLabel(emailInfo);
		lblNewLabel_9_2_1.setBounds(123, 110, 159, 16);
		lblNewLabel_9_2_1.setFont(new Font("Bookman Old Style", Font.BOLD, 14));
		...
		generateReport.setForeground(Color.BLACK); // Set the text color to black
		generateReport.setBackground(new Color(128, 128, 128)); // Set the background color to light gray
		generateReport.setFont(new Font("Bookman Old Style", Font.BOLD, 10));
		...
		btnNewButton_2_1.setForeground(Color.BLACK); // Set the text color to black
		btnNewButton_2_1.setFont(new Font("Bookman Old Style", Font.BOLD, 10));
		btnNewButton_2_1.setBorderPainted(false);
		btnNewButton_2_1.setBackground(Color.GRAY); // Set the background color to gray
		...
		btnCourses.setFont(new Font("Bookman Old Style", Font.BOLD, 13));
		...
		btnSettings.setFont(new Font("Bookman Old Style", Font.BOLD, 13));

		JButton btnLogOut = new JButton("Logout");
		btnLogOut.setForeground(new Color(0, 0, 0));
		btnLogOut.setBorderPainted(false);
		btnLogOut.setBackground(new Color(255, 255, 255));
		btnLogOut.setFont(new Font("Bookman Old Style", Font.BOLD, 13));
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_1.createSequentialGroup()
							.addComponent(btnCourses, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							.addGap(33))
						.addGroup(gl_panel_1.createSequentialGroup()
